...
src_install() {
    ...
    rm -f "${D}${QT5_LIBDIR}"/cmake/Qt5Gui/Qt5Gui_QPdfPlugin.cmake || die "remove QPdfPlugin.cmake failed"
    rm -f "${D}${QT5_LIBDIR}"/qt5/plugins/imageformats/libqpdf.so || die "remove qpdf imageprovider failed"
